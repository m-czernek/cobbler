...
schema = Schema(
    {
        ...
        Optional("grubconfig_dir", default="/usr/share/cobbler/lib/grub_config"): str,
        ...
        Optional(
            "signature_path", default="/usr/share/cobbler/lib/distro_signatures.json"
        ): str,
        Optional(
            "signature_url",
...
def migrate(settings: dict) -> dict:
    ...
    # Update paths to new defaults
    settings["autoinstall_snippets_dir"] = "/usr/share/cobbler/lib/snippets"
    settings["autoinstall_templates_dir"] = "/usr/share/cobbler/lib/templates"
    settings["webdir"] = "/usr/share/cobbler/www/"

    if "grubconfig_dir" in settings:
        settings["grubconfig_dir"] = "/usr/share/cobbler/lib/grub_config"

    if "signature_path" in settings:
        settings["signature_path"] = "/usr/share/cobbler/lib/distro_signatures.json"
